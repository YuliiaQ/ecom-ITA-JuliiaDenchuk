Feature: As a registered user
  I want to add product to Product Comparison
  So I can choose the best product
  ...
  Scenario: Successful adding product to Shopping Cart
    ...
    And I click ADD_CANON_EOS_TO_COMPARISON_BUTTON button
    Then Message successful adding "Success: You have added iPhone to your product comparison!" is displayed